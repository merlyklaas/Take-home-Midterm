...
```{r}
#p2 <-
looped_plots <- tibble(district = dat$district, 
                       plot = list())
...
```{r}
# midterm_plot <-
#   function(data, academic_year, v, v_se, given_district, n_school){
#     data_to_use <- data[which(data$district == given_district),]
#     p <- 
#       ggplot(
#       data = data_to_use,
#       aes(
...
```{r}
# for (i in 1:nrow(dat)){
#   district_i <- looped_plots$district[i]
#   looped_plots$plot[i] <-
#   midterm_plot(
#       data = dat, 
...
#       v = v, 
#       v_se = v_se, 
#       given_district = district_i, 
#       n_school = n_school
#       )
#   return(looped_plots$plot[i])
#   #return(looped_plots)
# }
```
